...
const CONTRACT_ADDRESS = process.env.EXAMINATION_REGISTRY_CONTRACT_ADDRESS || process.env.CONTRACT_ADDRESS || '0x5FbDB2315678afecb367f032d93F642f64180aa3';
// Default Hardhat Account #0 private key for local signing
const PRIVATE_KEY = process.env.BLOCKCHAIN_PRIVATE_KEY || process.env.BLOCKCHAIN_SIGNER_KEY || '0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80';
